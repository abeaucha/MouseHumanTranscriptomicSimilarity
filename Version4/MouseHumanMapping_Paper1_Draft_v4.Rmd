...
\edit{Armin comment: Include a Sankey diagram for top matches in Figure 1}

\edit{Rogier comment: Corresponding mouse and human regions have different colours in Figure 1}
...
fig2_cap_C <- "(C) Similarity matrix displaying the gene expression latent space correlation between 67 mouse regions and 88 human regions averaged over 500 MLP training runs. Similar brain regions exhibit very high correlation values."
