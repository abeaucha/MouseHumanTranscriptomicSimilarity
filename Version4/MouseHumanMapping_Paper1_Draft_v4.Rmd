...
```{r results3-fig5-interactive, include=FALSE, echo=FALSE, fig.width=8.5, fig.height=7.5}
grid.newpage()
grid.draw(fig5_grob)
```
...
Overall, we observe a strong association between the mouse caudoputamen and both the human caudate and putamen. While we find a subtle pattern of specificity to either region among voxels in the caudoputamen on the basis of maximal similarity, \edit{finish this sentence}.  


The majority of voxels in the caudoputamen exhibit high correlation with both of these regions


We find a strong association between voxels in the mouse nucleus accumbens and the human accumbens. 


very strong correlations between voxels in the caudoputamen and both human the caudate and putamen. We also find a strong correspondence between the nucleus accumbens in both species, 
