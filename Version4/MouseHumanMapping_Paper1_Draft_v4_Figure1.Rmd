...
meanCortex <- matSim_H88M67_AllGenes[indCortexHuman, indCortexMouse] %>% 
  as.numeric() %>% 
  mean()

sdCortex <- matSim_H88M67_AllGenes[indCortexHuman, indCortexMouse] %>% 
  as.numeric() %>% 
  sd()

meanNotCortex <- matSim_H88M67_AllGenes[!indCortexHuman, indCortexMouse] %>% 
  as.numeric() %>% 
  mean()

sdNotCortex <- matSim_H88M67_AllGenes[!indCortexHuman, indCortexMouse] %>% 
  as.numeric() %>% 
  sd()
...
meanNotCb <- matSim_H88M67_AllGenes[!indCbHuman, indCbMouse] %>% 
  as.numeric() %>% 
  mean()

sdNotCb <- matSim_H88M67_AllGenes[!indCbHuman, indCbMouse] %>% 
  as.numeric() %>% 
  sd()
...
print(round(meanCrus1, 2))
print(round(sdCrus1, 2))
```
