...
It is well established that the brains of most, if not all, extant mammalian species follow a common organizational blueprint inherited from a common early mammalian ancestor. In fact, this blueprint extends to the organization of the neocortex: A number of cortical subdivisions have consistently been identified in members of many distantly related mammalian species. These subdivisions consist primarily of regions involved in the processing of sensory information, specifically primary and secondary somatosensory, visual, and auditory areas. Moreover, all placental mammals appear to have cortical subdivisions corresponding to primary and secondary motor areas [@kaas_what_1983; @krubitzer_organization_1995; @rosa_evolution_1999; @kaas_reconstructing_2011; @kaas_origin_2019]. While it is clear that basic sensorimotor cortical regions are found in the majority of mammals, including mice and humans, there is much debate about the extent to which cortical areas involved in supramodal processing are conserved across different lineages. In particular, the lineages of present-day mice and humans diverged some 80 million years ago [@kaas_evolution_2012]. 
