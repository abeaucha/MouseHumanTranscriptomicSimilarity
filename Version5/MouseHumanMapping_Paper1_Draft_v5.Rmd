...
fig5_cap_B <- "(B) Distributions of average maximal correlation per sensorimotor or supramodal isocortical areas in each gene expression latent space. Grey lines correspond to individual latent spaces."
fig5_cap_C <- "(C) Hierarchical clustering of mouse and human isocortical regions based on average latent space correlation values. Mouse regions are annotated as sensorimotor or supramodal." 
fig5_cap_D <- c("(D) Within-cluster sum of squared distances for different numbers of mouse and human isocortical clusters in the average latent space and initial homologous gene space. We loosely selected an optimal solution of four clusters.")
fig5_cap <- str_c("Organization of mouse-human similarity in the isocortex.",
                  fig5_cap_A,
                  fig5_cap_B,
                  fig5_cap_C,
                  fig5_cap_D,
