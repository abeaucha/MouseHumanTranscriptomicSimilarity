...
```{r results2-fig3-grob, fig.width = 10, fig.height = 7.4}
...
sliceAMBALegend_panel_grob$vp <- viewport(x = unit(9.5, 'inch'),
                                          y = unit(1.4, 'inch'),
...
# fig3_ss_palette <- magma(n = 255, begin = 0.5)
# fig3_ss_palette <- mako(n = 255, begin = 0.2)
