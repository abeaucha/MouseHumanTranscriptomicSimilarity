...
```{r}
fig4_ss_legend_palette <- matrix(colorRampPalette(c("red", "yellow"))(255), nrow = 1, ncol = 100)
...
fig4_grob <- arrangeGrob(fig4_distributions_panel_grob, #1
                         ...
                         fig4_ss_grob, #8
                         ptemp_grob,
                         layout_matrix = rbind(c(NA, NA, 7, NA, NA, NA),
                                               c( 3,  2, 1, NA,  8,  9),
                                               c(NA, NA, 4, NA, NA,  9),
                                               c(NA, NA, 4, NA, NA, NA),
                                               c(NA, NA, 5, NA, NA, NA),
                                               c(NA, NA, 6, NA, NA, NA),
                                               c(NA, NA, 6, NA, NA, NA)),
                         widths = unit(c(0.60, 2.0, 2.2, 0.25, 2.5, 2.45), 'inch'),
                         heights = unit(c(0.4, 4.55, 0.09, 0.09, 0.175, 0.1, 0.6), 'inch'))
```
