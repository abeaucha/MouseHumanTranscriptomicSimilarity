...
```{r fig5_grob, fig.width=10, fig.height=7.8}
#Generate figure 5 grob
fig5_plots_grob <- arrangeGrob(gTree(children = gList(rectGrob(), fig5_heatmap_coltree_grob)), #1
                               ...
                               gTree(children = gList(rectGrob(), fig5_heatmap_annotationlegend_grob)), #7
                               gTree(children = gList(rectGrob(), fig5_heatmap_legend_grob)),  #8
                               ...
                               layout_matrix = rbind(c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
                                                     ...
                                                     c(NA, NA, NA,  6,  6,  7,  7, NA, NA, 12, NA),
                                                     c(NA, NA, NA,  6,  6,  7,  7, NA, NA, 13, NA),
                                                     c(NA, NA, NA,  6,  6,  7,  7, NA, NA, 14, NA),
                                                     c(NA, NA, NA,  6,  6,  8,  8, NA, NA, 14, NA),
                               ...
                               heights = unit(c(0.75, 0.5, 2, 0.2, 0.2, 0.4, 0.5, 0.4, 2, 0.25, 0.25, 0.25), 'inch'))
