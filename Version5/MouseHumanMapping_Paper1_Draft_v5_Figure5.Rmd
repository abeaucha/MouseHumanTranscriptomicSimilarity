...
```{r results3-supp-topmatches-table}
#Identify maximal similarity values for every seed and data set
dfSimilarityProfiles_Cx_MaxSim <- dfSimilarityProfiles_Cx %>%
  group_by(Data, Seed) %>% 
  filter(Similarity == max(Similarity)) %>% 
...
```{r results3-supp-topmatches-sankey-prop, fig.width = 10, fig.height = 5}
...
```{r results3-supp-topmatches-sankey-avg, fig.width=10, fig.height = 5}
...
```{r results3-supp-topmatches-grid-prop, fig.width=12, fig.height = 6}
...
```{r results3-supp-topmatches-grid-avg, fig.width=12, fig.height=6}
...
```{r results3-supp-topmatches-S1-table}
...
```
```{r results3-supp-topmatches-S1-plot, fig.width = 12, fig.height = 6}
...
```{r results3-supp-clustering-heatmap-mlp, fig.width = 12, fig.height = 6}
...
```{r results3-supp-clustering-heatmap-allgenes, fig.width = 12, fig.height = 6}
...
```{r results3-supp-clustering-screeplot}
...
```{r results3-supp-clustering-overlap-human, fig.width = 10, fig.height = 5}
library(mclustcomp)
...
```{r results3-supp-clustering-overlap-mouse, fig.width = 10, fig.height = 5}
...
```{r results3-supp-clustering-overlap-heatmap, fig.width = 14, fig.height = 8}
...
```{r results3-supp-clustering-clusterdist-mouse, fig.width = 10, fig.height = 5}
