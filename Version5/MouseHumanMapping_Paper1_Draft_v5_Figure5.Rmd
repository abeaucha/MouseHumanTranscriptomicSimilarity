...
fig5_heatmap_title_grob <- textGrob("Title panel C",
                                    x = 0,
                                    y = 0.5,
                                    just = c("left", "centre"))
```
...
fig5_wcss_title_grob <- textGrob("Title panel D",
                                 x = 0,
                                 y = 0.5,
                                 just = c("left", "centre"))
```
...
fig5_regionaldist_title_grob <- textGrob("Title panel A",
                                         x = 0,
                                         y = 0.5,
                                         just = c("left", "centre"))
```
...
fig5_cortexdist_title_grob <- textGrob("Title panel B",
                                       x = 0,
                                       y = 0.5,
                                       just = c("left", "centre"))
```
...
fig5_plots_grob <- arrangeGrob(textGrob("A.", gp = gpar(fontsize = 14, fontface = "bold")), #1
                               ...
                               heights = unit(c(0.1, 0.4, 2, 0.25, 0.25, 0.15, 0.4, 0.5, 2, 0.2, 0.2, 0.4, 0.5, 0.25), 'inch'))
