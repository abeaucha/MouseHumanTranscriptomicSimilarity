...
```{r results3-fig5-intext-2}
#Summary statistics for maximal correlation values by cortex type
...
```{r results3-fig5-intext-3}
#Compute the average correlation between the mouse S1 and cortical regions in the sensory-visual human cluster

#Extract similarity profiles from the average latent space isocortical similarity matrix
...
#Get cluster labels for k = 4 solution for human cortical regions
dfClustLabels_Human_MLP_4 <- cutree(hcHuman_MLP, k = 4) %>% 
  enframe(name = "HumanRegion",
          value = "k4")

#Join average similarity profiles and 4-cluster labels and compute the average correlation between mouse S1 and human regions in this cluster
