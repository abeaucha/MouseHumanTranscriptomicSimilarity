...
load(str_c(pathHome, "Draft/", "Version6/", "AMBALegendSlice.RData"))
...
# fileout <- str_c(pathHome, "Draft/", "Version6/", "Figure4.RData")
fileout <- str_c("/projects/abeauchamp/Projects/MouseHumanMapping/Paper_TranscriptomicSimilarity/Draft/Version6/Figure4.RData")
save(fig4_grob,
     fig4_width,
     fig4_height,
     file = fileout)
