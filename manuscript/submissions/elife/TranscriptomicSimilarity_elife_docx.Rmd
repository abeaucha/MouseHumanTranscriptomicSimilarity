...
output: 
  word_document: 
    reference_docx: "template_word_elife.docx"
...
fig1_cap <- str_c("Figure 1. Transcriptomic similarity in the mouse and human brains.",
                  fig1_cap_A,
                  fig1_cap_B,
                  fig1_cap_C,
...
fig2_cap_A <- str_c("(A) Voxel-wise expression maps from 2835 homologous genes in the AMBA were used to train the neural network to classify each mouse voxel into one of 67 atlas regions.", sep = " ")
...
fig2_cap <- str_c("Figure 2. Creating a new common space.",
                  fig2_cap_A,
                  fig2_cap_B,
                  fig2_cap_C,
...
fig3_cap <- str_c("Figure 3. Quantifying improvement in locality in gene expression latent space.",
                  fig3_cap_A,
                  fig3_cap_B,
                  fig3_cap_C,
...
fig5_cap_A <- "(A) Maximal correlation distributions of mouse isocortical regions. Points and error bars represent mean and 95% confidence interval over latent space samples. Linear regression using average maximal correlation values: $\\beta = -0.042$, 95% CI $[-0.087, 0.003]$, $t(17) = -1.854$, $p = 0.0812$."
fig5_cap_B <- "(B) Distributions of average maximal correlation for sensorimotor and supramodal isocortical areas in each gene expression latent space. Grey lines correspond to individual latent spaces. Linear mixed-effects regression: $\\beta = -0.042$, 95% CI $[-0.044, -0.040]$, $t(499) = -49.9$, $p < 2 \\cdot 10^{-16}$."
...
fig5_cap <- str_c("Figure 5. Similarity of mouse-human isocortical regions.",
                  fig5_cap_A,
                  fig5_cap_B,
                  fig5_cap_C,
                  fig5_cap_D,
...
fig6_cap <- str_c("Figure 6. Similarity among mouse and human striatal regions.",
                  fig6_cap_A,
                  fig6_cap_B,
                  fig6_cap_C,
...
fig2_supp1_cap <- str_c("Figure 2-figure supplement 1.",
...
fig5_supp1_cap <- str_c("Figure 5-figure supplement 1.",
...
fig5_supp2_cap_A <- "(A) Maximal correlation distributions of mouse isocortical regions. Points and error bars represent mean and 95% confidence interval over latent space samples."
fig5_supp2_cap_B <- "(B) Distributions of average maximal correlation for sensorimotor and supramodal isocortical areas in each cortical latent space. Grey lines correspond to individual latent spaces."
fig5_supp2_cap_C <- "(C) Hierarchical clustering of mouse and human isocortical regions based on average latent space correlation values. Mouse regions are annotated as sensorimotor or supramodal." 
fig5_supp2_cap_D <- c("(D) Within-cluster sum of squared distances for different numbers of mouse and human isocortical clusters in the average cortical latent space and initial homologous gene space.")
fig5_supp2_cap <- str_c("Figure 5-figure supplement 2.",
