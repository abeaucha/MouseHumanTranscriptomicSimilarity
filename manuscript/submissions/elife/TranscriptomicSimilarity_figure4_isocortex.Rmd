...
fig4_distributions_legend <- ggplot(tmp, 
...
```{r}
pdf(file = 'Figure4_isocortex.pdf',
    width = 5,
    height = 5)

grid.arrange(fig4_distributions,
             fig4_distributions_legend_grob, 
             heights = unit(c(0.8, 0.2), 'npc'))
