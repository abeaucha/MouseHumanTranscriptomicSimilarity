...
```{r results3-fig5-supp2-panelA-regionaldist}
...
fig5_supp2_regionaldist <- ggplot(dfSimilarityProfiles_Cx_MaxSim_Summary, 
                            aes(x = Seed, 
                                y = SimilarityMean,
...
fig5_supp2_regionaldist_grob <- ggplotGrob(fig5_supp2_regionaldist) %>% grid.force()

#Extract relevant grobs
fig5_supp2_regionaldist_legend_grob <- getGrob(fig5_supp2_regionaldist_grob, "guides.3-3-3-3")
fig5_supp2_regionaldist <- fig5_supp2_regionaldist + 
  theme(legend.position = "none")
fig5_supp2_regionaldist_grob <- ggplotGrob(fig5_supp2_regionaldist) %>% grid.force()
fig5_supp2_regionaldist_panel_grob <- getGrob(fig5_supp2_regionaldist_grob, "panel.7-5-7-5")
fig5_supp2_regionaldist_yaxis_grob <- getGrob(fig5_supp2_regionaldist_grob, "axis-l.7-4-7-4")
fig5_supp2_regionaldist_ytitle_grob <- getGrob(fig5_supp2_regionaldist_grob, "ylab-l.7-3-7-3")
fig5_supp2_regionaldist_xaxis_grob <- getGrob(fig5_supp2_regionaldist_grob, "axis-b.8-5-8-5")
fig5_supp2_regionaldist_xtitle_grob <- getGrob(fig5_supp2_regionaldist_grob, "xlab-b.9-5-9-5")

#Plot title for panel A
fig5_supp2_regionaldist_title_grob <- textGrob("Distributions of maximal correlation for mouse isocortical regions",
                                         x = 0,
                                         y = 0.5,
                                         just = c("left", "centre"))
```
...
```{r results3-fig5-supp2-panelB-cortextype}
...
#Plot
fig5_supp2_cortexdist <- ggplot(dfSimilarityProfiles_Cx_MaxSim_Compare,
...
#Convert plot to grob
fig5_supp2_cortexdist_grob <- ggplotGrob(fig5_supp2_cortexdist) %>% grid.force()

#Extract relevant grobs
fig5_supp2_cortexdist_panel_grob <- getGrob(fig5_supp2_cortexdist_grob, "panel.7-5-7-5")
fig5_supp2_cortexdist_yaxis_grob <- getGrob(fig5_supp2_cortexdist_grob, "axis-l.7-4-7-4")
fig5_supp2_cortexdist_ytitle_grob <- getGrob(fig5_supp2_cortexdist_grob, "ylab-l.7-3-7-3")
fig5_supp2_cortexdist_xaxis_grob <- getGrob(fig5_supp2_cortexdist_grob, "axis-b.8-5-8-5")
fig5_supp2_cortexdist_xtitle_grob <- getGrob(fig5_supp2_cortexdist_grob, "xlab-b.9-5-9-5")

#Plot title for panel B
fig5_supp2_cortexdist_title_grob <- textGrob("Distributions of maximal correlation for\nmouse cortical types",
                                       x = 0,
                                       y = 0.5,
                                       just = c("left", "centre"),
...
```{r results3-fig5-supp2-panelC-heatmap-processing}
...
```{r results3-fig5-supp2-panelC-heatmap-base}
...
fig5_supp2_heatmap_ggplot <- pheatmap(mat = t(matSim_Cx_MLP_ordered), 
...
```{r results3-fig5-supp2-panelC-heatmap-grobs}
#Convert heatmap ggplot to grob
fig5_supp2_heatmap_main_grob <- ggplotGrob(fig5_supp2_heatmap_ggplot) %>% grid.force()

#Extract relevant grobs
fig5_supp2_heatmap_matrix_grob <- getGrob(fig5_supp2_heatmap_main_grob, "matrix.4-3-4-3")
fig5_supp2_heatmap_coltree_grob <- getGrob(fig5_supp2_heatmap_main_grob, "col_tree.2-3-2-3")
fig5_supp2_heatmap_rowtree_grob <- getGrob(fig5_supp2_heatmap_main_grob, "row_tree.4-1-4-1")
fig5_supp2_heatmap_colnames_grob <- getGrob(fig5_supp2_heatmap_main_grob, "col_names.5-3-5-3")
fig5_supp2_heatmap_rownames_grob <- getGrob(fig5_supp2_heatmap_main_grob, "row_names.4-4-4-4")
fig5_supp2_heatmap_rowannotations_grob <- getGrob(fig5_supp2_heatmap_main_grob, "row_annotation.4-2-4-2")

#Modify row annotation parameters
fig5_supp2_heatmap_rowannotations_grob$width <- unit(0.8, 'npc')
fig5_supp2_heatmap_rowannotations_grob$x <- unit(0, 'npc')
fig5_supp2_heatmap_rowannotations_grob$just <- "left"
```

```{r results3-fig5-supp2-panelC-heatmap-annotationlegend}
#Get the grob for the annotation legend
fig5_supp2_heatmap_annotationlegend_grob <- getGrob(fig5_supp2_heatmap_main_grob, "annotation_legend.3-6-5-6")

#Modify parameters for the legend title
fig5_supp2_heatmap_annotationlegend_grob$children[[1]]$label <- "Type of cortex"
fig5_supp2_heatmap_annotationlegend_grob$children[[1]]$x <- unit(0.5, 'npc') 
fig5_supp2_heatmap_annotationlegend_grob$children[[1]]$y <- unit(0.8, 'npc') 
fig5_supp2_heatmap_annotationlegend_grob$children[[1]]$hjust <- NULL
fig5_supp2_heatmap_annotationlegend_grob$children[[1]]$vjust <- NULL
fig5_supp2_heatmap_annotationlegend_grob$children[[1]]$just <- c("centre", "centre")

#Modify parameters for the legend boxes
fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$height <- unit(0.2, 'inch')
fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$width <- fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$height
fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$x <- unit(0.08, 'npc')
fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$y <- unit(c(0.5, 0.2), 'npc')
fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$hjust <- NULL
fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$vjust <- NULL
fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$just <- c("left", "centre")

##Modify parameters for the legend text
fig5_supp2_heatmap_annotationlegend_grob$children[[3]]$x <- fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$x + unit(0.2, 'npc')
fig5_supp2_heatmap_annotationlegend_grob$children[[3]]$y <- fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$y
fig5_supp2_heatmap_annotationlegend_grob$children[[3]]$hjust <- NULL
fig5_supp2_heatmap_annotationlegend_grob$children[[3]]$vjust <- NULL
fig5_supp2_heatmap_annotationlegend_grob$children[[3]]$just <- c("left", "centre")
```

```{r results3-fig5-supp2-panelC-heatmap-legend}
#Create a custom legend for the heatmap fill

#Legend scale
#Generate the legend palette
fig5_supp2_heatmap_legend_palette <- matrix(heatmapPalette, nrow = 1, ncol = 100)

#Properties for the legend scale
fig5_supp2_heatmap_legend_scale_x <- as.numeric(fig5_supp2_heatmap_annotationlegend_grob$children[[2]]$x)        #x
fig5_supp2_heatmap_legend_scale_y <- 0.95     #y
fig5_supp2_heatmap_legend_scale_width <- 1 - 2*fig5_supp2_heatmap_legend_scale_x  #Width
fig5_supp2_heatmap_legend_scale_height <- 0.2 #Height

#Create the raster grob for the legend scale
fig5_supp2_heatmap_legend_scale_grob <- rasterGrob(fig5_supp2_heatmap_legend_palette,
                                             x = fig5_supp2_heatmap_legend_scale_x,
                                             y = fig5_supp2_heatmap_legend_scale_y,
                                             width = fig5_supp2_heatmap_legend_scale_width,
                                             height = fig5_supp2_heatmap_legend_scale_height,
                                             just = c("left", "top"))

#Legend text
#Properties for legend text
fig5_supp2_heatmap_legend_text_min <- min(matSim_Cx_MLP)
fig5_supp2_heatmap_legend_text_max <- max(matSim_Cx_MLP)
fig5_supp2_heatmap_legend_text_nlabels <- 5

fig5_supp2_heatmap_legend_text_seq <- c(0.2, 0.4, 0.6, 0.8)

fig5_supp2_heatmap_legend_text_x <- (fig5_supp2_heatmap_legend_text_seq/(fig5_supp2_heatmap_legend_text_max - fig5_supp2_heatmap_legend_text_min))*fig5_supp2_heatmap_legend_scale_width + fig5_supp2_heatmap_legend_scale_x
fig5_supp2_heatmap_legend_text_y <- fig5_supp2_heatmap_legend_scale_y - fig5_supp2_heatmap_legend_scale_height - 0.05

#Create the text grob for the legend text
fig5_supp2_heatmap_legend_text_grob <- textGrob(fig5_supp2_heatmap_legend_text_seq,
                                          x = fig5_supp2_heatmap_legend_text_x,
                                          y = fig5_supp2_heatmap_legend_text_y,
                                          just = c("center", "top"),
                                          gp = gpar(fontsize = 8))

#Legend title
#Properties for the legend title
fig5_supp2_heatmap_legend_title <- "Correlation"
fig5_supp2_heatmap_legend_title_x <- fig5_supp2_heatmap_legend_scale_x + fig5_supp2_heatmap_legend_scale_width/2
fig5_supp2_heatmap_legend_title_y <- fig5_supp2_heatmap_legend_text_y - 0.35

#Create the legend title grob
fig5_supp2_heatmap_legend_title_grob <- textGrob(fig5_supp2_heatmap_legend_title,
                                           x = fig5_supp2_heatmap_legend_title_x,
                                           y = fig5_supp2_heatmap_legend_title_y,
                                           just = c("center", "top"),
                                           gp = gpar(fontsize = 10,
                                                     fontface = "bold"))

#Combine the scale, text and title into a single grob
fig5_supp2_heatmap_legend_grob <- gTree(children = gList(fig5_supp2_heatmap_legend_scale_grob,
                                                   fig5_supp2_heatmap_legend_text_grob,
                                                   fig5_supp2_heatmap_legend_title_grob))

```

```{r results3-fig5-supp2-panelC-heatmap-titles}
#Row title
fig5_supp2_heatmap_rowtitle_grob <- textGrob("Mouse regions",
                                       x = 0.03,
                                       y = 0.1,
                                       just = c("left", "bottom"),
                                       gp = gpar(fontsize = 8,
...
#Column title
fig5_supp2_heatmap_coltitle_grob <- textGrob("Human regions",
                                       x = 0.5,
                                       y = 0.97,
                                       just = c("left", "centre"),
                                       rot = 270,
...
fig5_supp2_heatmap_title_grob <- textGrob("Clustering of mouse and human isocortical regions",
                                    x = 0,
                                    y = 0.5,
                                    just = c("left", "centre"))
```
...
```{r results3-fig5-supp2-panelD-wcss-processing}
...
```{r results3-fig5-supp2-panelD-wcss}
#Scree plot
fig5_supp2_wcss <- ggplot(dfWCSS, aes(x = k, y = wcss, col = data)) + 
...
#Convert plot to grob
fig5_supp2_wcss_grob <- ggplotGrob(fig5_supp2_wcss) %>% grid.force()

#Extract relevant grobs from plot
fig5_supp2_wcss_legend_grob <- getGrob(fig5_supp2_wcss_grob, "guide-box.11-5-11-5")
fig5_supp2_wcss <- fig5_supp2_wcss + 
  theme(legend.position = "none")
fig5_supp2_wcss_grob <- ggplotGrob(fig5_supp2_wcss) %>% grid.force()
fig5_supp2_wcss_panel_grob <- getGrob(fig5_supp2_wcss_grob, "panel.7-5-7-5")
fig5_supp2_wcss_yaxis_grob <- getGrob(fig5_supp2_wcss_grob, "axis-l.7-4-7-4")
fig5_supp2_wcss_ytitle_grob <- getGrob(fig5_supp2_wcss_grob, "ylab-l.7-3-7-3")
fig5_supp2_wcss_xaxis_grob <- getGrob(fig5_supp2_wcss_grob, "axis-b.8-5-8-5")
fig5_supp2_wcss_xtitle_grob <- getGrob(fig5_supp2_wcss_grob, "xlab-b.9-5-9-5")

#Plot title for panel D
fig5_supp2_wcss_title_grob <- textGrob("Mouse and human scree plots",
                                 x = 0,
                                 y = 0.5,
                                 just = c("left", "centre"))
```
...
```{r results3-fig5-supp2-grob, fig.width=10, fig.height=7.6}
#Grob for main plots in figure 5
fig5_supp2_plots_grob <- arrangeGrob(textGrob("A.", gp = gpar(fontsize = 14, fontface = "bold")), #1
                               fig5_supp2_regionaldist_title_grob, #2
                               textGrob("B.", gp = gpar(fontsize = 14, fontface = "bold")), #3
                               fig5_supp2_cortexdist_title_grob, #4
                               fig5_supp2_regionaldist_ytitle_grob, #5
                               fig5_supp2_regionaldist_yaxis_grob, #6
                               fig5_supp2_regionaldist_panel_grob, #7
                               fig5_supp2_cortexdist_ytitle_grob, #8
                               fig5_supp2_cortexdist_yaxis_grob, #9
                               fig5_supp2_cortexdist_panel_grob, #10
                               fig5_supp2_regionaldist_xaxis_grob, #11
                               fig5_supp2_cortexdist_xaxis_grob, #12
                               fig5_supp2_regionaldist_xtitle_grob, #13
                               fig5_supp2_cortexdist_xtitle_grob, #14
                               textGrob("C.", gp = gpar(fontsize = 14, fontface = "bold")), #15
                               fig5_supp2_heatmap_title_grob, #16
                               textGrob("D.", gp = gpar(fontsize = 14, fontface = "bold")), #17
                               fig5_supp2_wcss_title_grob, #18
                               fig5_supp2_heatmap_coltree_grob, #19
                               fig5_supp2_heatmap_rowtitle_grob,#20
                               fig5_supp2_wcss_ytitle_grob, #21
                               fig5_supp2_wcss_yaxis_grob, #22
                               fig5_supp2_wcss_panel_grob, #23
                               fig5_supp2_heatmap_rowtree_grob, #24
                               fig5_supp2_heatmap_rowannotations_grob, #25
                               fig5_supp2_heatmap_matrix_grob, #26
                               fig5_supp2_heatmap_rownames_grob, #27
                               fig5_supp2_heatmap_coltitle_grob, #28
                               fig5_supp2_heatmap_colnames_grob, #29
                               fig5_supp2_heatmap_annotationlegend_grob, #30
                               fig5_supp2_wcss_xaxis_grob, #31
                               fig5_supp2_wcss_xtitle_grob, #32
                               fig5_supp2_wcss_legend_grob, #33
                               fig5_supp2_heatmap_legend_grob, #34
                               layout_matrix = rbind(c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
                                                     ...
                                                     c(NA, NA, NA, 19, 19, 20, NA, 21, 22, 23, NA),
                                                     c(24, 24, 25, 26, 26, 27, NA, 21, 22, 23, NA),
                                                     c(NA, NA, 28, 29, 29, 30, 30, NA, NA, 31, NA),
                                                     c(NA, NA, 28, 29, 29, 30, 30, NA, NA, 32, NA),
                                                     c(NA, NA, 28, 29, 29, 30, 30, NA, 33, 33, NA),
                                                     c(NA, NA, 28, 29, 29, 34, 34, NA, 33, 33, NA),
                                                     c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA)),
                               widths = unit(c(0.25, 0.2, 0.2, 1.05, 2.8, 1.1, 0.4, 0.35, 0.3, 2.9, 0.1), "inch"),
                               heights = unit(c(0.15, 0.4, 2, 0.25, 0.25, 0.15, 0.4, 0.5, 2, 0.2, 0.2, 0.4, 0.5, 0.25), "inch"))

#Empty rectangle grob to form the border
fig5_supp2_border_grob <- rectGrob(gp = gpar(fill = NA))

#Grob for figure 5
fig5_supp2_grob <- gTree(children = gList(fig5_supp2_plots_grob,
                                    fig5_supp2_border_grob))

#Figure 5 width and height
fig5_supp2_width <- 10
fig5_supp2_height <- 7.6

#Save as pdf
pdf(file = "Figure5_Supplement2.pdf",
    width = fig5_supp2_width,
    height = fig5_supp2_height)
...
#Save figure grob
fileout <- "Figure5_Supplement2.RData"
save(fig5_supp2_grob,
     fig5_supp2_width,
     fig5_supp2_height,
     file = fileout)
```
